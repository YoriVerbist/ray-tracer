...
class camera {
  public:
    ...
    int max_depth         = 10;  // Max number of ray bounces into the scene
  ...
  private:
    ...
    void initialize() {
        ...
        // Calculate the vectors accross the horizondal and down the vertical
        // viewport edges
    ...
    point3 defocus_disk_sample() const {
        // Returns a random point in the disk surrounding the camera center
    ...
    color ray_color(const ray& r, int depth, const hittable& world, const hittable& lights) const {
        ...
        auto p1        = make_shared<cosine_pdf>(rec.p);
        mixture_pdf mixed_pdf(light_ptr, rec.p);
